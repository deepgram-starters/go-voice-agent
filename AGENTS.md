...
Go demo app for Deepgram Voice Agent.
...
```
feat(go-voice-agent): add diarization support
fix(go-voice-agent): resolve WebSocket close handling
refactor(go-voice-agent): simplify session endpoint
